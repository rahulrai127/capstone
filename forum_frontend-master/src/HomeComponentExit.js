...
class HomeComponentExit extends Component {
    ...
    fetch(){
          axios.get('http://localhost:3011/users/admin/exit')
          .then((response) => {
 ...
 render (){
    ...
    <h1 class='headline'>Exit Records</h1>
...
export default HomeComponentExit;