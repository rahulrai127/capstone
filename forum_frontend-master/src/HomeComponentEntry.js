...
class HomeComponentEntry extends Component {
    ...
    fetch(){
          axios.get('http://localhost:3011/users/admin/entry')
          .then((response) => {
 ...
 render (){
    ...
    <h1 class='headline'>Entry Records</h1>
...
export default HomeComponentEntry;